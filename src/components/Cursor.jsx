...
export const Cursor = () => {
  ...
  return (
    <>
      <div
        className={`z-50 fixed -translate-x-1/2 -translate-y-1/2 rounded-xl pointer-events-none transition-transform
        ${
            hoverButton ? "bg-transparent border-2 border-orange-600 w-10 h-10" : "bg-opacity-75 bg-orange-400 w-8 h-8"
        }`}
        ref={cursorOutline}
      ></div>
    </>
