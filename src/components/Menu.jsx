export const Menu=(props)=>{
    ...
    >
        <div
          className={`bg-orange-50 h-0.5 rounded-md w-full transition-all ${
            menuOpened ? "rotate-45  translate-y-0.5" : ""
          }`}
        />
        <div
          className={`bg-orange-50 h-0.5 rounded-md w-full my-1 ${
            menuOpened ? "hidden" : ""
          }`}
        />
        <div
    ...
    <div
        className={`z-10 fixed top-0 right-0 bottom-0 bg-orange-50 transition-all overflow-hidden flex flex-col rounded-l-3xl
      ${menuOpened ? "w-80" : "w-0"}`}
      >
