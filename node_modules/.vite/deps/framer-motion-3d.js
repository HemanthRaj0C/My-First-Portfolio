...
import {
  ...
  useFrame,
  useThree
} from "./chunk-GY26HQP4.js";
import "./chunk-2Q7Q4JCB.js";
import {
  Color,
  Euler,
  OrthographicCamera,
...
function CanvasComponent(_a, forwardedRef) {
  ...
  if (size.width > 0 && size.height > 0) {
    ...
    root.current.configure(Object.assign(Object.assign({}, props), { dpr: dpr || props.dpr, size: Object.assign(Object.assign({}, size), { top: 0, left: 0 }), events: events$1 || createPointerEvents })).render((0, import_jsx_runtime.jsx)(ErrorBoundary, { set: setError, children: (0, import_jsx_runtime.jsx)(React.Suspense, { fallback: (0, import_jsx_runtime.jsx)(Block, { set: setBlock }), children: (0, import_jsx_runtime.jsx)(MotionCanvasContext.Provider, { value: {
      dimensions,
      layoutCamera,
  ...
  return (0, import_jsx_runtime.jsx)("div", { ref: containerRef, id, className, tabIndex, style: Object.assign({ position: "relative", width: "100%", height: "100%", overflow: "hidden" }, style), children: (0, import_jsx_runtime.jsx)("canvas", { ref: o([canvasRef, forwardedRef]), style: { display: "block" }, children: fallback }) });
}
...
var LayoutCamera = (0, import_react6.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(motion.perspectiveCamera, Object.assign({ ref: o([cameraRef, ref]) }, props));
});
...
var LayoutOrthographicCamera = (0, import_react7.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(motion.orthographicCamera, Object.assign({ left: size.width / -2, right: size.width / 2, top: size.height / 2, bottom: size.height / -2, ref: o([cameraRef, ref]) }, props));
});
